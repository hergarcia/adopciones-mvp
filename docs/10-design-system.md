...
| `ClaimNewCodeRequest` | verification | quieto · pidiendo · esperando · error | «Mandarme un código nuevo al 099 123 456»: un pedido de código común, con la espera y el tope de la historia #10 y `NextCodeHint` fuera del botón. |
