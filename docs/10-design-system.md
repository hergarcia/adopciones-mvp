...
| `SavedToast` | profile | — | El aviso de guardado, montado en la pantalla a la que se llega y no en el formulario que se deja: el formulario se desmonta con la navegación y el aviso se iba con él antes de poder leerse. |
