...
// La puerta de publicar y solicitar (FR-013), para las historias que construyen esas acciones. Es
// el piso, nivel 1: el nivel mínimo que exija un publicador se suma encima, en esa historia
// (FR-013g). Las dos formas ejecutan `gateCheck`, que tiene test.
