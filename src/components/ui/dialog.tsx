...
// Solo confirmaciones irreversibles (docs/10 §Componentes). Entra y sale con fade, desde los
// keyframes de globals.css enganchados a los atributos de estado de Radix.
  ...
  return (
    <Primitive.Root>
      ...
      <Primitive.Portal>
        ...
        <Primitive.Content
          className={cn(
            'fixed top-1/2 left-1/2 w-[calc(100%-2rem)] max-w-[var(--measure)] -translate-x-1/2 -translate-y-1/2 rounded-card bg-canvas p-6 shadow-float',
