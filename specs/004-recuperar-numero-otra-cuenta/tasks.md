...
- [X] T041 `node scripts/walk.mjs --user --story recuperar-numero-otra-cuenta /verificar-telefono/en-otra-cuenta /verificar-telefono/quedarme /mi-perfil` para el design-reviewer, a 390 y 1280
